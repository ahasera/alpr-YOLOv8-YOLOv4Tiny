...
#uncomment line above for additional DEBUG if you have picamera problem
...
"""
picam2 = Picamera2() 
config = picam2.create_still_configuration(main={"size": (1920, 1080)}, buffer_count=8) # change res and buffer count there, lores removed because not relevant
